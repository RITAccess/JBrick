...
public class HelpBrowser {
	...
	private void buildUrls() {
		...
		String folder = "C:\\Documents and Settings\\pxs1160\\workspace\\jbrick\\help\\html";// dialog.open();
	...
	public void show() {
		...
		Action actionPrint = new Action("&Print", ImageDescriptor
				.createFromFile(HelpBrowser.class, "/images/e_print_topic.png")) {
			public void run() {
				// Printer

				PrintDialog printDialog = new PrintDialog(shell, SWT.SELECTED);
