...
public class DownloadAction extends JBricxAbstractAction{
	...
	public DownloadAction(final JBricxManager manager) {
		super("", new ImageIcon(DownloadAction.class.getResource("/icons/download.png")), manager);
	...
	public void actionPerformed(ActionEvent e) {
    	...
    	if(saved){
    	    this.getManager().getStatusPane().pushMessage(
    				NXTAccess.downloadToBrick(jBManager.getTabFolder().getSelection().getFileFullPath(), false, false),
    				true
    	    );
    	}
	}
