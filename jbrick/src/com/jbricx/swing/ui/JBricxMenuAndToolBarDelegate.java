...
public class JBricxMenuAndToolBarDelegate {
	...
	enum ActionSet{
		...
		GOTO(GotoAction.class, "Go-to line", KeyStroke.getKeyStroke(KeyEvent.VK_G, modifier + KeyEvent.SHIFT_MASK), 1, MenuEnum.toolsMenu),
		...
		DOWNLOADDEBUG(DownloadDebugAction.class, "Download Debug", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F7, 0), 2, MenuEnum.compileMenu),
