...
public class SyntaxScheme implements Cloneable, TokenTypes {
	...
	public void restoreDefaults(Font baseFont, boolean fontStyles) {
		...
		styles[COMMENT_MARKUP]			= new Style(literalNumber, null, commentFont);
		...
		styles[DATA_TYPE]				= new Style(regex, null, keywordFont);
		styles[VARIABLE]					= new Style(variable);
		styles[REGEX]						= new Style(regex);
		styles[ANNOTATION]				= new Style(literalNumber);
		...
		styles[MARKUP_TAG_DELIMITER]		= new Style(literalNumber);
		styles[MARKUP_TAG_NAME]			= new Style(literalNumber);
		styles[MARKUP_TAG_ATTRIBUTE]		= new Style(function);
